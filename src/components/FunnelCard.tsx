...
export function FunnelCard({ stage, count, total, index }: FunnelCardProps) {
  ...
  return (
    <Link to={`/estagio/${stage}`}>
      <div
        className="group relative overflow-hidden rounded-xl bg-card border border-border p-5 transition-all hover:shadow-lg hover:-translate-y-0.5 cursor-pointer animate-fade-in"
